...
libraryDependencies ++= Seq(
  ...
  // VMPR
  "dvla" %% "vehicles-presentation-common" % "2.59" withSources() withJavadoc() exclude("junit", "junit-dep"),
  "dvla" %% "vehicles-presentation-common" % "2.59" % "test" classifier "tests" withSources() withJavadoc() exclude("junit", "junit-dep")
)
...
lazy val osAddressLookupProject = osAddressLookup("0.32").disablePlugins(PlayScala, SbtWeb)
