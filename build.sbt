...
libraryDependencies ++= Seq(
  ...
  // VMPR
  "dvla" %% "vehicles-presentation-common" % "2.50" withSources() withJavadoc() exclude("junit", "junit-dep"),
  "dvla" %% "vehicles-presentation-common" % "2.50" % "test" classifier "tests" withSources() withJavadoc() exclude("junit", "junit-dep")
)
...
// ====================== Sandbox Settings ==========================
lazy val emailServiceProject = emailService("0.18").disablePlugins(PlayScala, SbtWeb)
...
lazy val vehicleAndKeeperLookupProject = vehicleAndKeeperLookup("0.24").disablePlugins(PlayScala, SbtWeb)
