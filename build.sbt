...
libraryDependencies ++= Seq(
  ...
  "dvla" %% "vehicles-presentation-common" % "2.47" withSources() withJavadoc() exclude("junit", "junit-dep"),
  "dvla" %% "vehicles-presentation-common" % "2.47" % "test" classifier "tests"  withSources() withJavadoc() exclude("junit", "junit-dep"),
...
lazy val vehiclesDisposeFulfilProject = vehiclesDisposeFulfil("0.17").disablePlugins(PlayScala, SbtWeb)
