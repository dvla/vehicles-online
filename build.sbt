...
libraryDependencies ++= Seq(
  ...
  "dvla" %% "vehicles-presentation-common" % "2.47-SNAPSHOT" withSources() withJavadoc() exclude("junit", "junit-dep"),
  "dvla" %% "vehicles-presentation-common" % "2.47-SNAPSHOT" % "test" classifier "tests"  withSources() withJavadoc() exclude("junit", "junit-dep"),
...
lazy val vehiclesDisposeFulfilProject = vehiclesDisposeFulfil("0.17-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
