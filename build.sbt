...
libraryDependencies ++= Seq(
  ...
  // VMPR
  "dvla" %% "vehicles-presentation-common" % "2.55" withSources() withJavadoc() exclude("junit", "junit-dep"),
  "dvla" %% "vehicles-presentation-common" % "2.55" % "test" classifier "tests" withSources() withJavadoc() exclude("junit", "junit-dep")
)
...
// ====================== Sandbox Settings ==========================
lazy val emailServiceProject = emailService("0.20").disablePlugins(PlayScala, SbtWeb)
