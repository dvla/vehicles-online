...
libraryDependencies ++= Seq(
  ...
  "dvla" %% "vehicles-presentation-common" % "2.6-SNAPSHOT" withSources() withJavadoc(),
  "dvla" %% "common-test" % "2.6-SNAPSHOT" % "test" classifier "tests" withSources() withJavadoc(),
...
lazy val vehiclesLookupProject = vehiclesLookup("0.5-SNAPSHOT").disablePlugins(PlayScala, SassPlugin, SbtWeb)
