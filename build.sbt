...
libraryDependencies ++= Seq(
  ...
  "dvla" %% "vehicles-presentation-common" % "8.32-SNAPSHOT" withSources() withJavadoc() exclude("junit", "junit-dep"),
  "dvla" %% "vehicles-presentation-common" % "8.32-SNAPSHOT" % "test" classifier "tests"  withSources() withJavadoc() exclude("junit", "junit-dep"),
