...
libraryDependencies ++= Seq(
  ...
  // VMPR
  "dvla" %% "vehicles-presentation-common" % "2.58-SNAPSHOT" withSources() withJavadoc() exclude("junit", "junit-dep"),
  "dvla" %% "vehicles-presentation-common" % "2.58-SNAPSHOT" % "test" classifier "tests" withSources() withJavadoc() exclude("junit", "junit-dep")
)
