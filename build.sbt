...
libraryDependencies ++= Seq(
  ...
  "dvla" %% "vehicles-presentation-common" % "2.10-SNAPSHOT" withSources() withJavadoc(),
  "dvla" %% "vehicles-presentation-common" % "2.10-SNAPSHOT" % "test" classifier "tests"  withSources() withJavadoc(),
