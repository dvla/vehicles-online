...
libraryDependencies ++= Seq(
  ...
  "dvla" %% "vehicles-presentation-common" % "2.11" withSources() withJavadoc() exclude("junit", "junit-dep"),
  "dvla" %% "vehicles-presentation-common" % "2.11" % "test" classifier "tests"  withSources() withJavadoc() exclude("junit", "junit-dep"),
